...
**`QUICK SUMMERY`** 🔹 A mechanism used by [web browsers](/understanding-web-browser-and-its-basic-architecture/) to locate and retrieve  any published content on the web.😄 
...
`:80` is the port. It indicates the technical "gate" used to access the resources on the web server. Default port of the HTTP protocol (80 for HTTP and 443 for HTTPS) is omited.
