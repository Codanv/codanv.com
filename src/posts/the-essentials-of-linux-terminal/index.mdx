---
title: "The Essentials of Linux Terminals"
description: "All the ingredients for perfect recipe!!!"
canonical: "https://www.codanv.com/posts/the-essentials-of-linux-terminals/"
date: 2020-07-22
...
Every system includes a command line of one sort or another. In the last article we have had [fun part of linux terminal](/posts/fun-part-of-linux-terminal)  where we came across "why does one even bother to learn linux commands?" and set your mood for learning them.
...
> There is also a directory `"root"` for superuser which is different from root `/` directory. Actually, `"root"` directory is an immediate subdirectory of `/` root directory.
