...
canonical: "https://www.codanv.com/posts/mern-crud-example-part2/"
date: 2020-06-13
...
In the [second part](/posts/mern-crud-example-part2) of the tutorial we are going to create front-end(user interface) for our basic contact web application.
